...
<div class="livepage">
<?php include 'theme-part/header-top-menu-sport.php'; ?>
...
<div class="container-fluid">
            <div class="row">
               ...
               <?php include 'sports-part/left-sidebar-inside.php'; ?>
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-5 col-md-offset-3">
                            ...
                            <div class="multiviewbox">
                                <div class="multiviewbox_name">Live mode</div>
                                <div class="multiviewbox_button">
                                 <a href="/sportbetting.php" class="active">off</a>
                                 <a href="/livesport.php">on</a>
                                </div>
                            </div>
                         ...
                         <div class="row centerstatistic_livesport"> 
                                        ...
                                        <div class="col-md-7 col-sm-12 sport_left_columb">
                                            <?php include 'sports-part/sports_onecolumb.php'; ?>
                                        </div>
                                        <div class="col-md-5 hidden-sm hidden-xs sport_right_columb">
                                              <div class="active-sport-box">
                                                   <div class="brandimage football_img">
                                                                <div class="line_of_command">
                                                                <div class="center_half_command"><span>Adanaspor</span> - <span>Istanbul Basaksehir FK</span></div>
