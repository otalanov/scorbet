...
<div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lgh-2 col-lg-3 col-md-3 col-sm-4">
                    
               <?php include 'sports-part/left-sidebar.php'; ?>
                    
                </div>
                
                 <div class="col-lgh-10 col-lg-9 col-md-9 col-sm-8">
                    ...
                    <div class="row centerstatistic_livesport">
                       ...
                       <div class="col-md-9 col-sm-12">
                        ...
                        <div class="col-md-12">
                           <?php include 'sports-part/live_right_now.php'; ?>     
                        </div>
                       
                        <div class="col-md-12">
                            <?php include 'sports-part/most_popular_mach.php'; ?>
                        </div>
                        ...
                        <div class="col-md-3 hidden-sm hidden-xs">
                           <?php include 'sports-part/slider.php'; ?>
